...
export default class BackAndCreate extends Component {
    render() {
        return (
            <div>
                <div className="">
                    ...
                    <NavLink to={{ pathname: "/" + this.props.pathn }}>
                        <div className="Next text-center d-inline-block">
                            <p className="Agreed-Text">AGREE AND PROCEED<img src={require('../../../assets/images/if_arrow_right.png')} class="if_arrow-right ml-3"></img></p>
                        </div>
                    </NavLink>
                </div>
            </div >
